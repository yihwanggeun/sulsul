...
class WhiskeylFragment : Fragment() {
      override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?): View? {
        val view = inflater.inflate(R.layout.fragment_whiskey, container, false)
        val whiskeyView = view.findViewById<GridView>(R.id.whiskeyView)
            ...
            override fun onResponse(call: Call, response: Response){
                ...
                if(resp != null){
                    CoroutineScope(Dispatchers.Main).launch {
                        ...
                        val gridView = view.findViewById<GridView>(R.id.whiskeyView)
